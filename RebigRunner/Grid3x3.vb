...
Public Class Grid3x3
	Public Const MAX_THREADS As Integer = 9

	Public ServerList(MAX_THREADS - 1) As String
	Public ServerExitCommand()         As Integer = {0, 0, 0, 0, 0, 0, 0, 0, 0}
	...
	Private Sub Control_Load() Handles MyBase.Load
		...
		IPArray         = New TextBox() {IP1        , IP2        , IP3        , IP4        , IP5        , IP6        , IP7        , IP8        , IP9        }
		LineArray       = New TextBox() {Line1      , Line2      , Line3      , Line4      , Line5      , Line6      , Line7      , Line8      , Line9      }  
		ErrorsArray     = New TextBox() {Errors1    , Errors2    , Errors3    , Errors4    , Errors5    , Errors6    , Errors7    , Errors8    , Errors9    }
		LoopsArray      = New TextBox() {Loops1     , Loops2     , Loops3     , Loops4     , Loops5     , Loops6     , Loops7     , Loops8     , Loops9     }
		LastTimeArray   = New TextBox() {LastTime1  , LastTime2  , LastTime3  , LastTime4  , LastTime5  , LastTime6  , LastTime7  , LastTime8  , LastTime9  }
		StateArray      = New TextBox() {State1     , State2     , State3     , State4     , State5     , State6     , State7     , State8     , State9     }
		CloseArray      = New  Button() {Close1     , Close2     , Close3     , Close4     , Close5     , Close6     , Close7     , Close8     , Close9     }
		TestArray       = New TextBox() {Test1      , Test2      , Test3      , Test4      , Test5      , Test6      , Test7      , Test8      , Test9      }
		DocumentArray   = New  Button() {Document1  , Document2  , Document3  , Document4  , Document5  , Document6  , Document7  , Document8  , Document9  }
		IndicatorArray  = New TextBox() {Indicator1 , Indicator2 , Indicator3 , Indicator4 , Indicator5 , Indicator6 , Indicator7 , Indicator8 , Indicator9 }
		IndicatorTArray = New TextBox() {Indicator1t, Indicator2t, Indicator3t, Indicator4t, Indicator5t, Indicator6t, Indicator7t, Indicator8t, Indicator9t}
		ModelArray		= New   Label() {Model1		, Model2	 , Model3	  , Model4	   , Model5		, Model6     , Model7	  , Model8	   , Model9		}
	...
	Private Sub MyBase_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles MyBase.KeyDown
		...
		ElseIf (e.Alt AndAlso e.KeyCode = Keys.D7) Or (e.Alt AndAlso e.KeyCode = Keys.NumPad7) Then
			Call OpenClientLog(6)

		ElseIf (e.Alt AndAlso e.KeyCode = Keys.D8) Or (e.Alt AndAlso e.KeyCode = Keys.NumPad8) Then
			Call OpenClientLog(7)

		ElseIf (e.Alt AndAlso e.KeyCode = Keys.D9) Or (e.Alt AndAlso e.KeyCode = Keys.NumPad9) Then
			Call OpenClientLog(8)
